...
As recommended I installed Vagrant and VirtualBox to run Ubuntu v.16.04. To achieve this, the **[Vagarantfile](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/code/Vagrantfile)** needed to be modified to reflect the correct version required for the setup. After installing the DataDog agent, the environment was ready for the exercise.
...
- **Tags**: 
  ...
  >
  > ![](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/1.png)
  >
  ...
  The final Host Map looked like this with the tags added:-

  ![](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/2.png)
...
- **Postgres**: 
  ...
  ![](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/3.png)

- **Custom Agent**: 

  In order to create a custom agent check, I followed the [documentation](https://docs.datadoghq.com/developers/write_agent_check/?tab=agentv6) and created a ***[my_metric.yaml](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/code/my_metric.yaml)*** file in `/etc/datadog-agent/conf.d` and ***[my_metric.py](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/code/my_metric.py)*** file in `/etc/datadog-agent/checks.d`. It is important to note that both files have to be of the same name, only with different extensions. 

  After restarting the agent and doing a status check showed the "my_metrics" info under Collectors. 

  ![](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/4.png)

  Another way I made sure the custom metric was collecting metrics was by running `sudo -u dd-agent -- datadog-agent check my_metric`. It was also visible on the Host Map:

  ![Screen Shot 2019-01-25 at 10.52.55 AM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/5.png)
...
![Screen Shot 2019-01-25 at 10.48.05 AM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/6.png)
...
- **Timeboard**:
  ...
  ![Screen Shot 2019-01-29 at 9.09.13 PM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/7.png)
...
>
> ​	![Screen Shot 2019-01-25 at 3.52.07 PM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/8.png)
...
![Screen Shot 2019-01-28 at 6.21.35 PM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/9.png)

​	

​	I sent myself a snapshot of this graph and received this notification on my email:

​	![Screen Shot 2019-01-25 at 4.18.09 PM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/10.png)
...
- **Metric Monitor**:
  ...
  ![screencapture-app-datadoghq-monitors-2019-01-25-17_44_00](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/11.png)

  

  This is the warning notification I received after setting up the trigger emails:

   	![Screen Shot 2019-01-25 at 6.52.45 PM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/12.png)
...
![Screen Shot 2019-01-25 at 8.05.28 PM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/16.png)	![Screen Shot 2019-01-25 at 8.05.38 PM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/13.png)
...
- **Flask App**:
  ...
  Since I frequently use Flask to build web apps, I installed Flask on the vagrant machine and then installed ddtrace. I utilized the provided sample application code and saved it as **[app.py](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/code/app.py)**. After that, I just needed to run dd-trace along with the app using `ddtrace-run python app.py` to start collecting the application's performance metrics. On a separate terminal, I kept hitting the app with curl requests and within a matter of seconds, the APM monitor was live on the UI.

  ![screencapture-app-datadoghq-apm-service-flask-flask-request-2019-01-27-12_20_58](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/14.png)
...
![Screen Shot 2019-01-28 at 10.29.37 PM](https://github.com/rmshree/hiring-engineers/blob/solutions-engineer/imgs/15.png)
