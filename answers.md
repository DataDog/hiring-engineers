...
I created a dashboard combining the check 'mymetric' and the trace of the python app we just created. ![Screenshot 18](https://github.com/HantingZHANG/hiring-engineers/blob/solutions-engineer/images/18.CustomedDashBoard.PNG)<br> Then I made it public using the options button on the top right corner, ![ScreenShot 19](https://github.com/HantingZHANG/hiring-engineers/blob/solutions-engineer/images/19.GeneratePublicURL.PNG). <br> 
