...
- **Bonus Question**: What is the difference between a Service and a Resource?
  `A service is a component within an app such as an API endpoint or a database. The number of services in an app may differ depending on the complexity of it. A resource is a connection to a service such as a database query or an API call.`
  <br/>
