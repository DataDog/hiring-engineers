...
- First spin up a vagrant virtual box or another container environment, then install the Agent. One way to do this is the quick install Ubuntu method shown here: 
...
- Also install PostgreSQL on the GUI and follow the steps provided, like creating the datadog user in psql with proper permissions.
