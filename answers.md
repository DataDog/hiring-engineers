...
**Below you will see the script utizlized for creating the timeboard.  I npm installed the dogapi package and created the script using this package to create the timeboard.  The timeboard was generated by running node *[file name]* in the terminal**
