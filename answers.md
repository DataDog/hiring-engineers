...
> - To check the status of the agent from the host, run: ``` docker exec -it <container_name> /opt/datadog-agent/bin/agent/agent status ```<br/><br/>
> _Other useful agent commands cona be [found here](https://docs.datadoghq.com/agent/faq/agent-commands/?tab=agentv6)_
> 
