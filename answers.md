...
<p>&nbsp;</p>
<p>Curl script used. Showing it is specifically filtered on a specific host.<br>
...
<br>
<br>
<strong>Load generator script for Flask:</strong><br>
<p>while true<br />do<br /> curl -i -H "Accept: application/json" -H "Content-Type: application/json" -X GET 0.0.0.0:5050 &gt; /dev/null<br /> sleep 23<br />done</p>
<br>
Provide a link and a screenshot of a Dashboard with both APM and Infrastructure Metrics.<br>
...
This could even apply to show regional locations of cloud hosted metrics.
