...
## 6. Final Question
After going through the backbone of datadog, it turns out to be more like a data-driven tool for my life. Well, I'm a food and beer lover and can't even bear a single drop of warm beer (taste so weird). So what I'm thinking is a tool which can help me to monitor my beer quantity and temperature. For the beer quantity, a digital weight scale connected with Raspberry Pi which sends data to datadog should do the job. For the temperature monitoring, I would use a thermometer to ensure the beer stays at an optimal temperature.  Once the weight goes below 2 bottles' weight, or the temperature gets too warm, the monitor triggers the alert and send me the notification. Ha, sounds like a solid system, I can even monitor my icecream, chocolate and all the tasty stuff! Happy monitoring!!
