...
Please refer to the two screenshots below or my account (liuqi_jp@hotmail.com) to check the metric monitor I created. https://docs.datadoghq.com/monitors/notifications/
