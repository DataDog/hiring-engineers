...
### Setting Up An Environment With Vagrant and Running The Datadog Agent
        ...
        **Attempt one:** 
        ...
        Wait.  I'm *inside* the VM, where docker doesn't exist yet, where nothing is installed.  Okay.  It was only a test and I'm running the wrong version of Ubuntu anyways.
        ...
        **Attempt two-threeish:**
        ...
        All I had to do was provide Docker to the vagrantfile, using `config.vm.provider "docker"` inside thr Vagrantfile, then boot it up and run the agent installation command, and this happened:
