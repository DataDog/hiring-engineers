...
*Screenshot below of whenever a monitor is triggered and email notification is received*     
...
*Screenshot below of downtime scheduled email notification recevied when downtime was scheduled*       
![Alt text](https://github.com/shahmoa/DD-Challenge-Exercise/blob/master/DowntimeScheduledEmailNotification.png)

*Screenshot below of downtime started email notification received when downtime started*       
