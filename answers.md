...
#### Terraform init
Ensuring we are in the "terraform" folder we can initialize terraform by running the command bellow
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/tf-init.png"Terraform init")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/tf-plan.png"Terraform plan")
...
If the command executed successfully, we should see an output similar to the one bellow
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/tf-apply.png"Terraform apply")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/eks-get.png"kubectl get all --all-namespaces")
...
If we have a look at the [Datadog HostMap page](https://app.datadoghq.eu/infrastructure/map) we can see that the agents are reporting and we can see the tags we defined in the daemonset manifest are present.
 ![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/ddog-hostmap.png"HostMap Agents")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/mymetric-dockerbuild.png"mymetric docker build")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/mymetric-dockerpush.png"mymetric docker push")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-dockerfile-apm.png"webapp apm")
...
The output of this command should be similar to this
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-dockerbuild.png"webapp docker build")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-dockerpush.png"webapp docker push")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/deployment-images.png"deployment images")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-apm.png"webapp apm env var")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-apm.png"mymetric interval env var")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/myapp-getdep.png"kubectl get deployments myapp")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/dashboard.png"Dashboard")
As well as navigate to our [Monitor list](https://app.datadoghq.eu/monitors/manage) where our new Monitor can also be viewed
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/monitor.png"Monitor")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/timeboard.png"Timeboard")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/monitor-definition.png"Monitor specs")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/monitor-message.png"Monitor email")
...
![alt text](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/downtime.png"Downtime")
