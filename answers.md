...
![Terraform init](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/tf-init.png)
...
![Terraform plan](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/tf-plan.png)
...
![Terraform apply](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/tf-apply.png)
...
![kubectl get all --all-namespaces](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/eks-get.png)
...
If we have a look at the [Datadog HostMap page](https://app.datadoghq.eu/infrastructure/map) we can see that the agents are reporting and we can see the tags we defined in the daemonset manifest are present.
 ![HostMap Agents](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/ddog-hostmap.png)
...
![mymetric docker build](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/mymetric-dockerbuild.png)
...
![mymetric docker push](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/mymetric-dockerpush.png)
...
![webapp apm](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-dockerfile-apm.png)
...
The output of this command should be similar to this
![webapp docker build](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-dockerbuild.png)
...
![webapp docker push](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-dockerpush.png)
...
![deployment images](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/deployment-images.png)
...
![webapp apm env var](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-apm.png)
...
![mymetric interval env var](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/webapp-apm.png)
...
![kubectl get deployments myapp](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/myapp-getdep.png)
...
![Dashboard](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/dashboard.png)
As well as navigate to our [Monitor list](https://app.datadoghq.eu/monitors/manage) where our new Monitor can also be viewed
![Monitor](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/monitor.png)
...
![Timeboard](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/timeboard.png)
...
![Monitor specs](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/monitor-definition.png)
...
![Monitor email](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/monitor-message.png)
...
![Downtime](https://github.com/affoliveira/hiring-engineers/tree/solutions-engineer/images/downtime.png)
