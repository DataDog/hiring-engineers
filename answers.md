...
I've always been fascinated by the similarity of animation/SFX rending workflows to an industrial factory manufacturing things (widgets, cars, toasters, etc).  The similarity is that in in both "pipelines" parts and raw materials come into one side pipeline and and some kind of finished product comes out the back door.
