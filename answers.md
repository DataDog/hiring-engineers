...
Conveniently, Vagrant has the a folder sync ability. After making sure that Virtual Box Guest Additions are installed on our host machine, we only need to add the following line to our Vagrantfile:
