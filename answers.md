...
Create a timeboard.py file under /etc/datadog-agent and attach the code as below. [timeboard.py](https://github.com/allenz16/hiring-engineers/blob/solutions-engineer/timeboard.py).👈
<div align="center">
<img src="https://github.com/allenz16/hiring-engineers/blob/solutions-engineer/screenshots/1010.PNG" width="750px" />
</div>
...
Then run the "python timeboard.py" cmd and check the "Dashboards" -- "Dashboards List", two graphs are created. The First graph combines the first two graphs requested in this section as displayed in the screenshot at the bottom, pink is the one with the rollup (1 hour sum) function (displayed as a dot on the graph) and the blue one is the normal my_metric. 
<div align="center">
<img src="https://github.com/allenz16/hiring-engineers/blob/solutions-engineer/screenshots/1000.PNG" width="750px" />
</div>
...
Create a test.py under /etc/datadog-agent and attach the code as below. [test.py](https://github.com/allenz16/hiring-engineers/blob/solutions-engineer/test.py).👈
<div align="center">
