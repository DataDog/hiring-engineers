**Sean Yu - Support Engineer - Sydney**  
*The host for this whole exercise was an Ubuntu 12.04 VM running on top of  Virtualbox.*
...
- [Table of Contents](#table-of-contents)
    - [Level 1 Collecting your Data](#level-1-collecting-your-data)
        - [1. Signing up for a Datadog Account](#1-signing-up-for-a-datadog-account)
        - [2. Bonus question 1](#2-bonus-question-1)
        - [3. Agent Config File](#3-agent-config-file)
        - [4. Database Integration](#4-database-integration)
        - [5. Custom Agent Check](#5-custom-agent-check)
    - [Level 2 Visualizing your Data](#level-2-visualizing-your-data)
        - [1. Adding Metrics](#1-adding-metrics)
        - [2. Bonus question 2](#2-bonus-question-2)
        - [3. Investigating a Graph](#3-investigating-a-graph)
    - [Level 3 Alerting on your Data](#level-3-alerting-on-your-data)
        - [1. Setting up a Monitor](#1-setting-up-a-monitor)
        - [2. Bonus points](#2-bonus-points)
        - [3. Sharing Graphs](#3-sharing-graphs)
        - [4. Advance Monitor Setup](#4-advance-monitor-setup)
        - [5. Bonus](#5-bonus)
...
---
### 1. Signing up for a Datadog Account
...
### 2. Bonus question 1 
>Task: In your own words, what is the Agent?
...
### 2. Bonus question 2 
>Task: What is the difference between a timeboard and a screenboard?
...
### 2. Bonus points
>Task: Make it a multi-alert by host so that you won't have to recreate it if your infrastructure scales up.  
...
### 4. Advance Monitor Setup
>Task: This monitor should alert you within 15 minutes. So when it does, take a screenshot of the email that it sends you.

<img src="./pics/47EmailNotification.png">

### 5. Bonus
>Task: Since this monitor is going to alert pretty often, you don't want to be alerted when you are out of the office. Set up a scheduled downtime for this monitor that silences it from 7pm to 9am daily. Make sure that your email is notified when you schedule the downtime and take a screenshot of that notification.
...
The scheduled downtime works!  
<img src="./pics/52DowntimeEmail.png">
