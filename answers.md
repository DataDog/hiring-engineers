...
<br>
<br>
<strong>Load generator script:</strong><br>
<p>Load generator script for Flask:<br />while true<br />do<br /> curl -i -H "Accept: application/json" -H "Content-Type: application/json" -X GET 0.0.0.0:5050 &gt; /dev/null<br /> sleep 23<br />done</p>
<br>
