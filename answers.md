...
As for the APM, I would use it to track resource traffic on a website. It sounds pretty boring, but this was an actual idea I once had. I once had built a restaurant website where users can login and post their own recipe for certain dishes. The owner then select every week several dishes to serve. If the owner of the restaurant can see which dishes are most viewed/popular it would make it easier for him to decide. He can also see which category people are most interested in and serve more of that at any given week.