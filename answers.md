...
Then running **ab -n 8000 -c 10 http://127.0.0.1:8000/** from the command line would load the page multiple times over a couple of minutes. I messed around with the command until the graphs turned out satisfactory looking.
