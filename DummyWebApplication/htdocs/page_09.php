	...
	<body>
		...
		<?php
			...
			echo "<p>It took:      $elapsed_time seconds</p>";
  			...
  			Datadogstatsd::increment('web.page_views', 1, array('tagname' => 'support', 'tagname' => 'page_09'));
  			
  			# Record the page load time
  			Datadogstatsd::histogram('web.page_load_time', $elapsed_time, 0.5, array('tagname' => 'support', 'tagname' => 'page_09'));
