...
* Change your check's collection interval so that it only submits the metric once every 45 seconds. Can you do this via configuration and without modifying your code?
